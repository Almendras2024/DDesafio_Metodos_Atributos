...
class Pizza:
    ...
    def realizar_pedido(self):
        ...
        """
        self.i_proteico = input(
            "Por favor ingrese el tipo de proteína (pollo, vacuno, carne vegevactal): "
        )
        self.vegetal_1 = input(
            "Por favor ingrese el primer ingrediente vegetal (tomates, aceitunas, champiñones): "
        )
        self.vegetal_2 = input(
            "Por favor ingrese el segundo ingrediente vegetal (tomates, aceitunas, champiñones): "
        )
        self.t_masa = input(
            "Por favor ingrese el tipo de masa (tradicional, delgada): "
        )
